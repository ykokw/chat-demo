...
class Thread extends React.Component {
    constructor(props) {
        ...
        db.collection('messages').orderBy('created_at').onSnapshot(collections => {
            const messages = [];
    ...
    render () {
        return (
            <KeyboardAvoidingView behavior="padding" contentContainerStyle={styles.thread} style={styles.thread}>
                <FlatList
                    style={styles.list}
